...
namespace Business.ValidationRules.FluentValidation.IncomeAndExpensesType
{
    public class UpdateValidator : AbstractValidator<IncomeAndExpensesTypeUpdateDto>
    {
