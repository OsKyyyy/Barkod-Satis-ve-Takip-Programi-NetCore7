...
{
    public class AddValidator : AbstractValidator<ProductAddDto>
    {
        public AddValidator()
        {
            ...
            RuleFor(r => r.CreateUserId).NotEmpty().WithMessage("Bu alan boş olamaz").GreaterThan(0).WithMessage("Bu alan 0'dan büyük değer olmalıdır"); ;
        }
    }
}
