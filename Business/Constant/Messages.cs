...
namespace Business.Constant
{
    public static class Messages
    {
        ...
        public static string ProductStockEntry = "Ürünlere Stok Girişi Yapıldı";
        public static string ProductStockEntryError = "Ürüne Stok Girişi Yapılırken Hata İle Karşılaşıldı";
        public static string ProductUpdated = "Ürün Güncellendi";
        public static string ProductsListed = "Ürünler Listelendi";
        public static string FavoriteProductsListed = "Favori Ürünler Listelendi";
        public static string CategoryProductsListed = "Kategoriye Göre Listelendi";
