    ...
    public class ProductManager : IProductService
    {
        ...
        public IResult Add(ProductAddDto productAddDto)
        {
            ...
            var product = new Product
            {
				...
				UnitPrice = decimal.Parse(productAddDto.UnitPrice, _culture),
				UnitType = productAddDto.UnitType,
        ...
        public IResult Update(ProductUpdateDto productUpdateDto)
        {
            ...
            var category = new Product
            {
                ...
                Origin = productUpdateDto.Origin,
                UnitPrice = decimal.Parse(productUpdateDto.UnitPrice, _culture),
                UnitType = productUpdateDto.UnitType,
