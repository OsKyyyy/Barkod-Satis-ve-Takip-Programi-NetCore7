...
(function ($, undefined) {
    ...
    $.fn.czMore = function (options) {
        ...
        return this.each(function () {
            ...
            var divPlus = '<button id="btnPlus" class="btn btn-icon btn-success" /><i class="ki-duotone ki-plus fs-2"></i></button>';
            ...
            function loadMinus(recordset) {
                var divMinus = '<button id="btnMinus" class="btn btn-icon btn-danger" /><i class="ki-duotone ki-minus fs-2"></i></button>';
