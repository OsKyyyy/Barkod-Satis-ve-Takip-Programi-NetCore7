            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return "<a class='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1' href='/Report/SalesProductsDetailReport/" + row.id + "'><i class='ki-duotone ki-eye fs-2'><span class='path1'></span><span class='path2'></span><span class='path3'></span></i></a><button class='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1' onclick='Report.PrintReceipt(" + row.id +")'><i class='ki-duotone ki-printer fs-2'><span class='path1'></span><span class='path2'></span><span class='path3'></span><span class='path4'></span><span class='path5'></span></i></button><a class='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1' href = '/Sale/Delete/" + row.id +"' onclick='Report.DeleteConfirm(this)'><i class='ki-duotone ki-trash fs-2'><span class='path1'></span><span class='path2'></span><span class='path3'></span><span class='path4'></span><span class='path5'></span></i></a>";                        
                    }
                },
                {
                    targets: 6,
