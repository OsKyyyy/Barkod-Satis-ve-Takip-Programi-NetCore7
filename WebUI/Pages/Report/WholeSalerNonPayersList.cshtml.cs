...
{
    public class WholeSalerNonPayersListModel : PageModel
    {
        private readonly IReport _report;

        public WholeSalerNonPayersListModel(IReport report)
        {
            _report = report;
        }
        ...
        public List<WholeSalerNonPayersViewModel> ViewModel { get; set; }
