...
{
    public class WholeSalerTotalDebtListModel : PageModel
    {
        private readonly IReport _report;

        public WholeSalerTotalDebtListModel(IReport report)
        {
            _report = report;
        }
        ...
        public List<WholeSalerDebtViewModel> ViewModel { get; set; }
