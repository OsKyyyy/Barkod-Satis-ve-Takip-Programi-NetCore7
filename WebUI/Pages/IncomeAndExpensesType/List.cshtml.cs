...
namespace WebUI.Pages.IncomeAndExpensesType
{
    public class ListModel : PageModel
    {
        ...
        public ListModel(IIncomeAndExpensesType incomeAndExpensesType)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var response = await _incomeAndExpensesType.List("Bearer " + HttpContext.Session.GetString("userToken"));
